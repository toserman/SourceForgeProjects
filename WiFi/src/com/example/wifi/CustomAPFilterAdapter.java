...
public class CustomAPFilterAdapter extends BaseAdapter {
	public List<ScanResult> listData;
...
//     		inholder.wifi_capab_icon.setImageResource(R.drawable.encrypted); 	
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {        	
            convertView = layoutInflater.inflate(R.layout.filter_ap_listview, null);            
            ...
            holder.ap_filter_checkbox = (CheckBox)convertView.findViewById(R.id.check_ap_filter);
            //holder.ap_filter_checkbox.isChecked();
            holder.ap_filter_checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            	public int check;
				@Override				
				public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
					Log.d("MY CustomAPFilterAdapter: ","onCheckedChanged: " + Boolean.toString(buttonView.isChecked()));					
...
//					 = this.getListAdapter().getItem(position);
					...
					Log.d("MY CustomAPFilterAdapter: ","onCheckedChanged: " + keyword);
						    
				
					
//					Toast.makeText(this, "You selected: " + keyword, Toast.LENGTH_SHORT).show();
//			buttonView.getTag(key)(buttonView);
//			buttonView.getT
...
//            Log.d("MY CustomAPFilterAdapter: ", "art getView() " + Integer.toString(call_counter++));
            holder.ap_filter_checkbox.setTag(listData.get(position));
            Log.d("MY CustomAPFilterAdapter: ", "TEST: " + (listData.get(position).SSID));
        ...
        //}
//        holder.ap_filter_checkbox.getId();
      Log.d("MY CSListAdapter: SSID: ", listData.get(position).SSID +" position = " + Integer.toString(position)); 
        holder.ssidname.setText(listData.get(position).SSID);
        if(holder.ap_filter_checkbox.isChecked()) {
        	Log.d("MY CustomAPFilterAdapter:", holder.ssidname.getText() + Boolean.toString(holder.ap_filter_checkbox.isChecked()));
        	Log.d("MY CustomAPFilterAdapter:", "listData SSID:" + listData.get(position).BSSID);
        }
